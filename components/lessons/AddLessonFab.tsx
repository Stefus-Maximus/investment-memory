  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-[calc(env(safe-area-inset-bottom)+1.25rem)] right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-amber-700 text-white shadow-md transition-transform hover:bg-amber-800 active:scale-95"
      >
